...
@dp.message_handler(filters.ChatTypeFilter(types.ChatType.PRIVATE),text="💰Balans")
...
@dp.message_handler(filters.ChatTypeFilter(types.ChatType.PRIVATE),state='balans', content_types=types.ContentTypes.ANY)
...
@dp.message_handler(filters.ChatTypeFilter(types.ChatType.PRIVATE),text="❌Bekor qilish", state=["tel_raqam_yuborish", 'karta_raqam_yuborish', "karta_egasi_ismi", "search"])
async def sfgklfmbgk(msg : types.Message, state : FSMContext):
    await msg.answer('<b>❌Bekor qilindi\n\nMenu : </b>', reply_markup=menu.menu)
    await state.finish()
    
@dp.message_handler(filters.ChatTypeFilter(types.ChatType.PRIVATE),state="tel_raqam_yuborish", content_types=types.ContentTypes.ANY)
...
@dp.message_handler(filters.ChatTypeFilter(types.ChatType.PRIVATE),state= "karta_raqam_yuborish")
...
@dp.message_handler(filters.ChatTypeFilter(types.ChatType.PRIVATE),state="karta_egasi_ismi")
